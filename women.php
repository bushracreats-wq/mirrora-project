...
<div class="container-fluid px-4 mt-4 mb-5">
    ...
    <div class="d-flex align-items-center mb-4 mt-4 border-bottom pb-2">
        <h3 class="m-0 fw-bold ps-2 category-heading">Women Collection</h3>
    </div>
...
<a href="wishlist.php?action=add&id=<?php echo $row['id']; ?>" class="wishlist-icon-btn" title="Add to Wishlist">
    <i class="far fa-heart"></i>
        ...
        <?php 
            ...
            echo "<div class='col-12'><p class='text-muted small fst-italic ps-2'>No products found in Women collection.</p></div>";
        }
        ?>
    </div>
</div>
